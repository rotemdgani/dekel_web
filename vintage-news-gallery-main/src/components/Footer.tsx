...
import "./Footer.css";
import logo from "@/assets/logo_dh_edition.png";
          ...
          <div className="footer-columns">
            <div className="footer-links">
              ...
              <nav className="footer-nav">
                ...
                <Link to="/exhibitions" className="footer-link">Exhibitions</Link>
                <Link to="/press" className="footer-link">Press / Awards</Link>
